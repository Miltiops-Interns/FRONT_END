    ...
    <div className="s1">
      <div className="celu">
        <div className="circles">
          <div className="c1"><div className="ice" /></div>
          <div className="c2"><div className="pizza" /><div className="cir" /></div>
          <div className="c3"><div className="tarta" /></div>
          <div className="c4"><div className="fact" /></div>
          <div className="c5"><div className="salad" /></div>
        </div>
      </div>
    </div>
  );
...
export default function FoodScene() {
  return (
    <div className="food-scene-root">
      {/* Keep the CSS scoped inside the component for a single-file solution */}
      <style>{`
        ...
        @keyframes sube {
          0%,25%{}
           30%, 35%, 40%, 45%, 50%, 55%, 60%, 65%, 70%,75%,80%,85%{transform:translateY(-21px)}
